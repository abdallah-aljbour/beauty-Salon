      ...
      {/* <div class="text-black dark:text-black pt-8 dark:bg-white" id="reviews">
        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
          ...
          <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
            <div class="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-white dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none text-black">
              <div class="flex gap-4">
                ...
                />
                <div>
                  <h6 class="text-lg font-medium text-black dark:text-black">
                    Daniella Doe
                  </h6>
