    ...
    <>
      ...
      <div className="m-8 grid grid-cols-3 grid-rows gap-5">
        <div className="row-start-1 row-end-2 col-start-1 col-end-3  ">
          <p>
            The first beauty center of its kind in Aqaba Governorate, offers a
            comprehensive beauty experience, as it features a variety of
            services including hair care, professional makeup, manicure,
            relaxing massages, luxurious Turkish/Moroccan bath experiences, in
            addition to sugar and waxing services for skin care.
          </p>
          <br />
          <iframe
